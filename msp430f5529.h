...
#error msp430f5529.h file for use with ICC430/A430 only
#endif
...
//#define RESERVED             (0x001Cu)       /* SYSRSTIV : Reserved */
...
#define TA0IV_TACCR3        (0x0006u)    /* TA0CCR3_CCIFG */
#define TA0IV_TACCR4        (0x0008u)    /* TA0CCR4_CCIFG */
...
#define TA2IV_TACCR2        (0x0004u)    /* TA2CCR2_CCIFG */
...
#define TA2IV_TA2CCR2      (0x0004u)    /* TA2CCR2_CCIFG */
...
#define USCI_UCRXIFG        (0x0002u)    /* Interrupt Vector: UCRXIFG */
#define USCI_UCTXIFG        (0x0004u)    /* Interrupt Vector: UCTXIFG */
...
#define USCI_I2C_UCRXIFG    (0x000Au)    /* Interrupt Vector: I2C Mode: UCRXIFG */
#define USCI_I2C_UCTXIFG    (0x000Cu)    /* Interrupt Vector: I2C Mode: UCTXIFG */
...
#define TLV_CRC_LENGTH        (0x1A01u)    /* CRC length of the TLV structure */
#define TLV_CRC_VALUE         (0x1A02u)    /* CRC value of the TLV structure */
...
#define USB_UBM_VECTOR      (51u * 2u) /* 0xFFE6 USB Timer / cable event / USB reset */
